...
RUN_STRINGS = (
    "Đỏ không mua, xanh lấy gì mà bán?",
    "Tâm lí như lol mà đòi dồn shark",
    "Việt Nam chúng tôi bắt cá mập đi kho hết rồi",
    "Out hàng chốt lãi không bao giờ là sai cả",
...
@run_async
def cham_ngon_trader(bot: Bot, update: Update):
    update.effe
    ctive_message.reply_text(random.choice(RUN_STRINGS))
...
__help__ = """
 ...
 - /cham_ngon_trader: reply a random string from an array of replies.
...
RUNS_HANDLER = DisableAbleCommandHandler("cham_ngon_trader", Châm Ngôn Trader)
